...
The bolded name in each entry below is the canonical domain string. A record's `domain` field must contain it verbatim: lowercase, matched exactly (SCHEMA.md).

...
DOMAINS = {
    ...
    "immunology": "science",
    "genomics": "biology and ecology",
    "toxicology": "medicine-style diagnosis",
    "sports medicine": "medicine-style diagnosis",
    "civil engineering": "engineering and physical systems",
    "petroleum engineering": "engineering and physical systems",
    "nuclear safety": "engineering and physical systems",
    "signal processing": "engineering and physical systems",
    "cartography": "engineering and physical systems",
    "antitrust law": "law and regulation",
    "immigration law": "law and regulation",
    "environmental regulation": "law and regulation",
    "central banking": "economics and markets",
    "venture capital": "economics and markets",
    "behavioral economics": "economics and markets",
    "cryptocurrency markets": "economics and markets",
    "game theory": "mathematics",
    "hospital logistics": "finance and business operations",
    "airline revenue management": "finance and business operations",
    "inventory forecasting": "finance and business operations",
    "hydrology": "science",
    "climatology": "science",
    "seismology": "science",
    ...
    "network security": "formal grammars and symbol systems",
    "typography": "formal grammars and symbol systems",
    "epigraphy": "formal grammars and symbol systems",
    "type theory": "algorithms and program analysis",
    "graph algorithms": "algorithms and program analysis",
    "operating systems": "program behavior",
    "embedded systems": "program behavior",
    "mycology": "biology and ecology",
    "ornithology": "biology and ecology",
    "coral-reef ecology": "biology and ecology",
    "logistics routing": "logic puzzles",
}
...
KERNELS = [
    ...
    "a measurement is confounded by the instrument that takes it",
    "a scarce resource creates a queue that must be prioritized",
    "two independent faults coincide to defeat a single safeguard",
    "an optimization must trade one objective off against another",
    "a delayed effect hides the cause that produced it",
]
REGISTERS = [
    ...
    "step-by-step tutorial", "grant proposal", "safety data sheet",
    "arbitration ruling", "product review", "onboarding checklist",
    "release notes",
]
ENTITY_MODES = [
...
TWISTS = [
    ...
    "arrange sufficient data so it looks incomplete",
    "hide the decisive fact inside a plausible distractor",
    "make a correct-looking shortcut yield a subtly wrong value",
    "require rejecting a premise that is stated as settled fact",
]
